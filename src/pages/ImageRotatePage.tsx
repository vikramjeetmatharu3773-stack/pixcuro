  ...
  return (
    <div className="container-wide py-8">
      ...
      <div className="space-y-5">
        ...
        <button type="button" className="btn-secondary w-full" onClick={() => { if (original?.url) URL.revokeObjectURL(original.url); if (preview?.url) URL.revokeObjectURL(preview.url); setOriginal(null); setPreview(null); setState(null); }}>Start over</button>
      </div>
    </div>
  );
}
