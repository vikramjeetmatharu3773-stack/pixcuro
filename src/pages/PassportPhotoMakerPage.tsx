...
function LivePreview({ source, foreground, state, originalUrl, onRender }: { source: HTMLImageElement; foreground: HTMLImageElement; state: EditorState; originalUrl: string; onRender: (canvas: HTMLCanvasElement, blob: Blob) => void }) {
