...
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`}},Fp=e=>{uu(e.inputs),e.compute(lu(e.inputs))}}),du,fe,jp,Kp,Qp,Zp,Xp,Jp,Yp,eh,th,pu,rh,ih,ah,nh,rr,sh,Br,oh,uh,lh,dh,ph,hh,ch,fh,mh,gh,yh,_h,wh,$h,bh,vh,Ei,xh,ha,ca,Sh,kh,Th,hu,cu,Ch,Da=q(()=>{ee(),se(),be(),ue(),du=(e,t,i,r,n,o,s)=>{let l=Math.ceil(t/4),d="";typeof n=="string"?d=`${n}(a)`:d=n("a");let h=N("inputData",i,[l],4),m=K("outputData",r,[l],4),g=[{name:"vec_size",type:"u32"}];return s&&g.push(...s),`
...
}`,oh=e=>{let t=Ae(e.inputs[0].dataType);e.compute(fe(e.inputs[0],"Erf",i=>`erf_vf32(${i})`,Br(t)))},uh=e=>{e.compute(fe(e.inputs[0],"Exp","exp"))},lh=e=>{e.compute(fe(e.inputs[0],"Floor","floor"))},dh=e=>{let t=Ae(e.inputs[0].dataType);e.compute(fe(e.inputs[0],"Gelu",i=>`0.5 * ${i} * (1.0 + erf_vf32(${i} * 0.7071067811865475))`,Br(t)))},ph=(e,t)=>{let i=Ae(e.inputs[0].dataType);e.compute(fe(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<${i}>(0.0))`,`const leaky_relu_alpha_ = ${i}(${t.alpha});`,t.cacheKey))},hh=e=>{e.compute(fe(e.inputs[0],"Not",t=>`!${t}`))},ch=e=>{e.compute(fe(e.inputs[0],"Neg",t=>`-${t}`))},fh=e=>{e.compute(fe(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},mh=e=>{let t=Ae(e.inputs[0].dataType);e.compute(fe(e.inputs[0],"Relu",i=>`select(vec4<${t}>(0.0), ${i}, ${i} > vec4<${t}>(0.0))`))},gh=e=>{e.compute(fe(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},yh=e=>ge(e),_h=(e,t)=>{let i=Ae(e.inputs[0].dataType);e.compute(fe(e.inputs[0],"HardSigmoid",r=>`max(vec4<${i}>(0.0), min(vec4<${i}>(1.0), ${t.alpha} * ${r} + vec4<${i}>(${t.beta})))`,void 0,t.cacheKey))},wh=e=>{e.compute(fe(e.inputs[0],"Sin","sin"))},$h=e=>{e.compute(fe(e.inputs[0],"Sinh","sinh"))},bh=e=>{e.compute(fe(e.inputs[0],"Sqrt","sqrt"))},vh=e=>{e.compute(fe(e.inputs[0],"Tan","tan"))},Ei=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,xh=e=>{e.compute(fe(e.inputs[0],"Tanh",Ei))},ha=(e="f32")=>`
...
`,cu=e=>`quick_gelu_impl(${e})`,Ch=(e,t)=>{let i=Ae(e.inputs[0].dataType);e.compute(fe(e.inputs[0],"QuickGelu",cu,hu(i,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),fu,mu,Ih,py=q(()=>{se(),ue(),Da(),fu=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},mu=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let i=N("input",e[0].dataType,e[0].dims,4),r=N("bias",e[0].dataType,[e[0].dims[2]],4),n=K("output",e[0].dataType,t,4),o=O.size(t)/4,s=Ce(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:l=>`
  ...
  fn calculateInputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
  }`,$u=(e,t)=>{let i=e.length,r=[];for(let n=0;n<i;++n){let o=t.setByOffset("global_idx",e[n].getByIndices("indices"));i===1?r.push(o):n===0?r.push(`if (inputIndex == ${n}u) { ${o} }`):n===i-1?r.push(`else { ${o} }`):r.push(`else if (inputIndex == ${n}) { ${o} }`)}return r.join(`
`)},bu=(e,t,i,r)=>{let n=O.size(i),o=new Array(e.length),s=new Array(e.length),l=0,d=[],h=[],m=[{type:12,data:n}];for(let b=0;b<e.length;++b)l+=e[b].dims[t],o[b]=l,h.push(e[b].dims.length),s[b]=N(`input${b}`,r,h[b]),d.push("rank"),m.push({type:12,data:o[b]});for(let b=0;b<e.length;++b)m.push(...Z(e[b].dims));m.push(...Z(i));let g=K("output",r,i.length),y=g.indicesGet("indices",t),_=Array.from(Array(o.length).keys()).map(b=>`uniforms.sizeInConcatAxis${b}`).join(","),w=b=>`
...
`}return de};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${g};${y};${_};${n}`,inputDependencies:b?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:o?o(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(w/64)},programUniforms:$}),getShaderSource:k}}}),vu,xu,fa,zi,Su,ma,ku,qr,Va=q(()=>{ee(),se(),ue(),It(),qa(),Ua(),vu=(e,t)=>e?`
...
`},ku=(e,t,i,r,n=!1)=>{let[o,s,l,d]=r,h=Ce(r[0].type.tensor);return`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${g}`,inputDependencies:w},getRunData:()=>({outputs:[{dims:r?r(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(y/64)},programUniforms:_}),getShaderSource:b}},jh=(e,t,i,r)=>{let n=e.length>2,o=$e(i[3]),s=$e(i[2]),l=O.size(i)/o/s,d=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/o],h=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/o],m=[i[0],i[1],i[2],i[3]/o],g=[{type:12,data:l},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];kt(t,g),g.push(...Z(d,h,m));let y=(s-1)*t.strides[1]+h[1],_=w=>{let b=K("output",e[0].dataType,m.length,o),S=Ce(b.type.tensor),x=St(t,b.type.value,S),$=N("x",e[0].dataType,d.length,o),k=N("w",e[1].dataType,h.length,o),T=[$,k];n&&T.push(N("b",e[2].dataType,e[2].dims,o));let I=n?"value += b[output_channel];":"",A=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return Tt(t,A),`
...
`)};
  ...
  ${y.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((_,w)=>w!==1).map(_=>_.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(_,w)=>"rank")},getRunData:()=>({outputs:[{dims:l,dataType:h}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:g}),getShaderSource:y}},lc=(e,t)=>{let i=e.inputs;tl(i,t),e.compute(rl(e.inputs,t))},dc=e=>ge({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),il,al,pc,hc,Ey=q(()=>{ee(),se(),be(),ue(),il=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  }`};return g?{name:"GemmShared",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:w},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:h*m},programUniforms:_}),getShaderSource:S}:{name:"Gemm",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:w},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(y/64)},programUniforms:_}),getShaderSource:b}},cc=e=>{let t=e.transA,i=e.transB,r=e.alpha,n=e.beta;return{transA:t,transB:i,alpha:r,beta:n,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}},fc=(e,t)=>{nl(e.inputs),e.compute(sl(e.inputs,t))}}),Je,at,yt,_t,ol,ul,ll,dl,pl,hl,cl,fl,mc,gc,Ay=q(()=>{ee(),se(),be(),ue(),[Je,at,yt,_t]=[0,1,2,3],ol=e=>{if(e[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(e[0].dims.length!==e[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw new Error("grid batch size must match input batch size")},ul=`
...
fn calculateOutputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
}`,$l=e=>{let t=e.length,i=[];for(let r=0;r<t;++r){let n=e[r].setByIndices("indices","input[global_idx]");t===1?i.push(n):r===0?i.push(`if (output_number == ${r}u) { ${n} }`):r===t-1?i.push(`else { ${n} }`):i.push(`else if (output_number == ${r}) { ${n} }`)}return`
...
`)}
  ...
  }`};return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${d};${l};${y}`,inputDependencies:b},getRunData:()=>({outputs:[{dims:w,dataType:1}],dispatchGroup:{x:g},programUniforms:S}),getShaderSource:x},{inputs:[t,i,r],outputs:[-1]})[0]},xl=(e,t,i)=>{let r=t[0].dims,n=r,o=2,s=r[0],l=r[1],d=O.sizeFromDimension(r,o),h=$e(d),m=O.size(n)/h,g=qi(e,t[0],t[1],t[2],s,d,l,i.epsilon),y=[s,l,d/h],_=[s,l],w=["type","none"],b=S=>{let x=N("x",t[0].dataType,y.length,h),$=N("scale_shift",1,_.length,2),k=K("output",t[0].dataType,y.length,h),T=[x,$,k];return`
  ...
  ${I.mainStart()}
    ...
    ${$?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        }`};return{name:"MatMulNBits",shaderCache:{hint:`${t.blockSize};${t.bits};${g};${y};${_};${b};${x}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:w,dataType:m}],dispatchGroup:{x:S},programUniforms:$}),getShaderSource:A}},zl=(e,t)=>{let i=e[0].dims,r=i.length,n=i[r-2],o=t.k,s=t.n,l=i.slice(0,r-2),d=O.size(l),h=e[1].dims[2]/4,m=e[0].dataType,g=$e(t.k),y=$e(h),_=l.concat([n,s]),w=128,b=s%8===0?8:s%4===0?4:1,S=w/b,x=S*y*8,$=x/g,k=x/t.blockSize,T=O.size(_)/b,I=[],A=[d,n,o/g],z=O.convertShape(e[1].dims).slice();z.splice(-1,1,h/y),I.push(...Z(A)),I.push(...Z(z)),I.push(...Z(e[2].dims)),e.length===4&&I.push(...Z(O.convertShape(e[3].dims)));let D=[d,n,s];I.push(...Z(D));let V=H=>{let X=A.length,te=N("a",e[0].dataType,X,g),W=N("b",12,z.length,y),oe=N("scales",e[2].dataType,e[2].dims.length),de=[te,W,oe],F=e.length===4?N("zero_points",12,e[3].dims.length):void 0;F&&de.push(F);let le=D.length,pe=K("output",e[0].dataType,le),j=Ce(e[0].dataType),he=()=>{switch(g){case 1:return`
    ...
    `,l="",d=N("x",t.dataType,t.dims.length),h=["rank"],[m,g,y,_,w]=Li(o,n);return m.push(...Z(t.dims,o)),{name:e,shaderCache:{hint:`${r.cacheKey};${y};${_};${w}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:o,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(O.size(o)/64)},programUniforms:m}),getShaderSource:b=>Gi(b,d,t.dims.length,o.length,n,s,l,t.dataType===10?-65504:-1e5,g,y,_,w)}},Bc=(e,t)=>{Zt(e.inputs),e.compute(Qi("MaxPool",e.inputs[0],!1,t))},Nc=e=>{let t=e.storage_order,i=e.dilations,r=Fi(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let n={storageOrder:t,dilations:i,...r,cacheKey:""};return{...n,cacheKey:Wl(n)}},Mc=e=>{let t=e.format;return{format:t,...Ki,cacheKey:t}},Dc=(e,t)=>{Zt(e.inputs),e.compute(Qi("GlobalMaxPool",e.inputs[0],!0,t))}}),ql,Vl,Pc,Uc,Uy=q(()=>{ee(),se(),be(),ue(),ql=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((i,r)=>i===e[2].dims[r]).reduce((i,r)=>i&&r,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((n,o)=>o===t.axis||n===e[0].dims[o]).reduce((n,o)=>n&&o,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let i=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(i/r)||t.blockSize>Math.ceil(i/(r-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Vl=(e,t)=>{let i=O.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,n=r===3,o=e[0].dims,s=e[1].dataType,l=O.size(o),d=r===3||r===2,h=d?[Math.ceil(O.size(e[0].dims)/4)]:e[0].dims,m=e[1].dims,g=e.length>2?e[2]:void 0,y=g?d?[Math.ceil(O.size(g.dims)/4)]:g.dims:void 0,_=m.length===0||m.length===1&&m[0]===1,w=_===!1&&m.length===1,b=$e(l),S=_&&(!d||b===4),x=S?b:1,$=S&&!d?b:1,k=N("input",d?12:r,h.length,$),T=N("scale",s,m.length),I=g?N("zero_point",d?12:r,y.length):void 0,A=K("output",s,o.length,x),z=[k,T];I&&z.push(I);let D=[h,m];g&&D.push(y);let V=[{type:12,data:l/x},{type:12,data:i},{type:12,data:t.blockSize},...Z(...D,o)],H=X=>{let te=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"Range",shaderCache:{hint:`${r}`},getShaderSource:d,getRunData:()=>({outputs:[{dims:o,dataType:r}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:l})}},Wc=e=>{let t=0,i=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],i=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],i=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),we.webgpu.validateInputContent&&Ll(t,i,r),e.compute(Gl(t,i,r,e.inputs[0].dataType),{inputs:[]})}}),Hl,Fl,qc,Vc,qy=q(()=>{ee(),se(),be(),ue(),Hl=(e,t,i,r)=>{if(e!=="none"&&r!=="i32"&&r!=="u32"&&r!=="f32")throw new Error(`Input ${r} is not supported with reduction ${e}.`);let n=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,o=`;
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${Hl(t.reduction,"output[data_offset + i]","value",w.type.value)}
      ...
      }`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:h}),getShaderSource:m}},qc=e=>ge({reduction:e.reduction}),Vc=(e,t)=>{e.compute(Fl(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),jl,Kl,Ql,Zi,Zl,Xl,Jl,Yl,ed,td,rd,id,Xi,ad,nd,sd,od,ud,Lc,Gc,Vy=q(()=>{ee(),se(),be(),ue(),jl=(e,t)=>{if(e.every(i=>i>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`:"",ad=(e,t,i,r,n)=>{let[o,s,l,d]=i.length===2?[-1,0,1,-1]:[0,2,3,1],h=e.type.value;return`
    ...
    }`},nd=(e,t,i,r,n,o,s,l,d,h)=>{let m=i.length===2,[g,y]=m?[0,1]:[2,3],_=e.type.value,w=b=>{let S=b===g?"row":"col";return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${_} {
    ...
    depth = max(0, min(depth, ${i[s]} - 1));
    ...
    }`},od=(e,t,i,r,n,o)=>{let s=e.dims,l=Jl(o,t.axes,s.length),d=Yl(s,r,n,t.axes),h=r.slice();r.length===0&&(h=s.map(($,k)=>$===0?1:d[k]/$),t.keepAspectRatioPolicy!=="stretch"&&(d=ed(s,h,t)));let m=K("output",e.dataType,d.length),g=N("input",e.dataType,s.length),y=O.size(d),_=s.length===d.length&&s.every(($,k)=>$===d[k]),w=t.coordinateTransformMode==="tf_crop_and_resize",b=t.extrapolationValue,S=g.type.value,x=$=>`
      ${_?"":`
      ...
      ${(()=>{switch(t.mode){case"nearest":return`
              ...
              ${(()=>{if(s.length===2||s.length===4)return`${ad(g,m,s,w,b)}`;if(s.length===3||s.length===5)return`${sd(g,m,s,w,b)}`;throw Error("Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.")})()};
            `;case"cubic":return`
